// A mirror of the backend lexicon for quick UI color hints
export const POS_WORDS = new Set([
  "love", "awesome", "great", "good", "wonderful", "happy", "delightful", "smile", "best", "fresh", "friendly", "helpful",
  "proud", "fantastic", "exciting", "excellent", "amazing", "like", "fun", "cool", "nice", "wow", "brilliant", "super"
]);
export const NEG_WORDS = new Set([
